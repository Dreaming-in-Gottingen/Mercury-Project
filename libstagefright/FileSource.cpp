...
/*
 * low efficient when read small amount Bytes(especially ts file extractor)
 * because system-call cost too much.
 * this is why we need TinyCacheSource,
 * which read page-size data to memory.
 */
